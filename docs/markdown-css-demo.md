...
-- like Github's and Markdown Here -- support syntax highlighting. Which languages are supported and
...
(and not-really-languages, like diffs and HTTP headers); to see the complete list, and how to write the language names,
...
## A heading
Just a note, I've found that I can't test my markdown parser vs others. For example, both markdown.js
and showdown code blocks in lists wrong. They're also completely [inconsistent][test] with regards to paragraphs in list items.
...
## Another Heading
Hello *world*. Here is a [link](https://hello). And an image ![alt](https://sindresorhus.com/tylerlong/github-markdown-css-demo/blob/master/src).
...
아래 문서는 [Markdown Syntax](https://github.com/markdownlint/markdownlint/blob/master/example/markdown_spec.md)
에서 가져왔습니다.
